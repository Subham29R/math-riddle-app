  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light.copyWith(
        statusBarColor: Color(0xFF7A5DF5),
      ),
      child: Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: CircularProgressIndicator(
                                  ...
                                  strokeWidth: 6,
                                  backgroundColor: Color(0xFF7A5DF5).withOpacity(0.1),
                                  valueColor: AlwaysStoppedAnimation(Color(0xFF7A5DF5)),
                                ),
                              ),
                              ScaleTransition(
                      ...
                      Text(
                        "You've completed ${widget.level - 1} questions",
